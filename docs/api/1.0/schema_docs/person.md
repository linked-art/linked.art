...
<span class="description"><p>List of <code>Person</code> entities</p>
</span>
...
<span class="description"><p>Reference to a <code>Person</code><br />
See: <a href="person.html">Schema</a></p>
</span><a href="#identified_by_items_anyOf_i1_assigned_by_items_carried_out_by_items_anyOf_i0" onclick="anchorLink('identified_by_items_anyOf_i1_assigned_by_items_carried_out_by_items_anyOf_i0')" class="ref-link">Same definition as E21_Person</a>
        </div>
    </div>
        </div></div></div>
...
<span class="description"><p>The event in which this Person was born</p>
</span>
...
<span class="description"><p>The event in which this Person died</p>
</span>
