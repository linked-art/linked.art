...
<span class="description">_la:Set_
A collection of other resources, such as a set of objects or places.
[API](https://linked.art/api/1.0/endpoint/set/) | [Model](https://linked.art/model/collection/)</span> <span class="badge badge-info no-additional">No Additional Properties</span>
...
<span class="description">List of equivalent `Set` entities</span>
...
<div class="accordion" id="accordionmembers_contained_by">
    <div class="card">
        <div class="card-header" id="headingmembers_contained_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#members_contained_by"
                        aria-expanded="" aria-controls="members_contained_by" onclick="setAnchor('#members_contained_by')"><span class="property-name">members_contained_by</span></button>
            </h2>
        </div>

        <div id="members_contained_by"
             class="collapse property-definition-div" aria-labelledby="headingmembers_contained_by"
             data-parent="#accordionmembers_contained_by">
            <div class="card-body pl-5">

    <h4>la:members_contained_by</h4><span class="badge badge-dark value-type">Type: array</span><br/>
<span class="description">A physical object that this object is contained by (like a box or folder) or supported by (like a shelf)</span>
         ...
         <span class="badge badge-info no-additional">No Additional Items</span><h4>Each item of this array must be:</h4>
    <div class="card">
        <div class="card-body items-definition" id="members_contained_by_items">
...
<div class="accordion" id="accordionmembers_exemplified_by">
    <div class="card">
        <div class="card-header" id="headingmembers_exemplified_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#members_exemplified_by"
                        aria-expanded="" aria-controls="members_exemplified_by" onclick="setAnchor('#members_exemplified_by')"><span class="property-name">members_exemplified_by</span></button>
            </h2>
        </div>

        <div id="members_exemplified_by"
             class="collapse property-definition-div" aria-labelledby="headingmembers_exemplified_by"
             data-parent="#accordionmembers_exemplified_by">
            <div class="card-body pl-5">

    <h4>la:members_exemplified_by</h4><span class="badge badge-dark value-type">Type: array of object</span><br/>
<span class="description">Note Well: Nothing below this is validated! Exemplar templates for members of the set</span>
         ...
         <span class="badge badge-info no-additional">No Additional Items</span><h4>Each item of this array must be:</h4>
    <div class="card">
        <div class="card-body items-definition" id="members_exemplified_by_items">
