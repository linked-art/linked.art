...
---
     ...
     <h1>Digital Object Schema</h1><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description">_dig:D1\_Digital\_Object_
A digital resource, such as a web page or image.
See: [API](https://linked.art/api/1.0/endpoint/digital_object/) | [Model](https://linked.art/model/digital/)</span> <span class="badge badge-info no-additional">No Additional Properties</span>
...
<span class="const-value" id="type_allOf_i1_const">Specific value: <code>"DigitalObject"</code></span>
...
<span class="description">List of equivalent `DigitalObject` entities</span>
...
<br/><div id="type_allOf_i0_ex1" class="jumbotron examples"><div class="highlight"><pre><span></span><span class="s2">&quot;Person&quot;</span>
    ...
    <h4>Specific</h4><span class="badge badge-dark value-type">Type: const</span><br/>
<span class="const-value" id="equivalent_allOf_i1_items_type_allOf_i1_const">Specific value: <code>"DigitalObject"</code></span>
...
<span class="description">A URL from which the digital object is able to be retrieved</span>
    ...
    <h4>dig:D1_Digital_Object
See: [Schema](digital.html)</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description">Reference to a `DigitalObject`</span><a href="#equivalent_allOf_i1_items" onclick="anchorLink('equivalent_allOf_i1_items')" class="ref-link">Same definition as dig:D1_Digital_Object
See: [Schema](digital.html)</a>
        </div>
    </div>
            </div>
        </div>
...
<div class="accordion" id="accordionpart_of">
    ...
    <h4>crm:P106i_forms_part_of</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description">Reference to another Digital Object of which this is part</span>
...
<div class="accordion" id="accordionconforms_to">
    <div class="card">
        <div class="card-header" id="headingconforms_to">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#conforms_to"
                        aria-expanded="" aria-controls="conforms_to" onclick="setAnchor('#conforms_to')"><span class="property-name">conforms_to</span></button>
            </h2>
        </div>

        <div id="conforms_to"
             class="collapse property-definition-div" aria-labelledby="headingconforms_to"
             data-parent="#accordionconforms_to">
            <div class="card-body pl-5">

    <h4>dcterms:conformsTo</h4><span class="badge badge-dark value-type">Type: array</span><br/>
<span class="description">A standard or specification that this entity conforms to or embodies</span><a href="#representation_items_digitally_shown_by_items_conforms_to" onclick="anchorLink('representation_items_digitally_shown_by_items_conforms_to')" class="ref-link">Same definition as conforms_to</a>
            </div>
        </div>
    </div>
</div>
<div class="accordion" id="accordionaccess_point">
    <div class="card">
        <div class="card-header" id="headingaccess_point">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#access_point"
                        aria-expanded="" aria-controls="access_point" onclick="setAnchor('#access_point')"><span class="property-name">access_point</span></button>
            </h2>
        </div>

        <div id="access_point"
             class="collapse property-definition-div" aria-labelledby="headingaccess_point"
             data-parent="#accordionaccess_point">
            <div class="card-body pl-5">

    <h4>la:access_point</h4><span class="badge badge-dark value-type">Type: array</span><br/>
<span class="description">A URL from which the digital object is able to be retrieved</span><a href="#representation_items_digitally_shown_by_items_access_point" onclick="anchorLink('representation_items_digitally_shown_by_items_access_point')" class="ref-link">Same definition as access_point</a>
            </div>
        </div>
    </div>
</div>
<div class="accordion" id="accordiondigitally_available_via">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via"
                        aria-expanded="" aria-controls="digitally_available_via" onclick="setAnchor('#digitally_available_via')"><span class="property-name">digitally_available_via</span></button>
            </h2>
        </div>

        <div id="digitally_available_via"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via"
             data-parent="#accordiondigitally_available_via">
            <div class="card-body pl-5">

    <h4>la:digitally_available_via</h4><span class="badge badge-dark value-type">Type: array</span><br/>
<span class="description">A digital service that may be interacted with in order to retrieve or act upon the digital object</span>
         ...
         <span class="badge badge-info no-additional">No Additional Items</span><h4>Each item of this array must be:</h4>
    <div class="card">
        <div class="card-body items-definition" id="digitally_available_via_items">
            

    <h4>la:DigitalService</h4><span class="badge badge-dark value-type">Type: object</span><br/>
...
<div class="accordion" id="accordiondigitally_available_via_items_type">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via_items_type">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via_items_type"
                        aria-expanded="" aria-controls="digitally_available_via_items_type" onclick="setAnchor('#digitally_available_via_items_type')"><span class="property-name">type</span></button>
            </h2>
        </div>

        <div id="digitally_available_via_items_type"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via_items_type"
             data-parent="#accordiondigitally_available_via_items_type">
            <div class="card-body pl-5">

    <br/>
<div class="all-of-value" id="digitally_available_via_items_type_allOf"><h2 class="handle">
  <label>All of</label>
</h2><ul class="nav nav-tabs" id="tabsdigitally_available_via_items_type_allOf_allOf" role="tablist"><li class="nav-item">
            <a class="nav-link active allOf-option"
               id="digitally_available_via_items_type_allOf_i0" data-toggle="tab" href="#tab-pane_digitally_available_via_items_type_allOf_i0" role="tab"
               onclick="setAnchor('#digitally_available_via_items_type_allOf_i0')"
            >General</a>
        </li><li class="nav-item">
            <a class="nav-link allOf-option"
               id="digitally_available_via_items_type_allOf_i1" data-toggle="tab" href="#tab-pane_digitally_available_via_items_type_allOf_i1" role="tab"
               onclick="setAnchor('#digitally_available_via_items_type_allOf_i1')"
            >Specific</a>
        </li></ul>
<div class="tab-content card"><div class="tab-pane fade card-body active show"
             id="tab-pane_digitally_available_via_items_type_allOf_i0" role="tabpanel">
...
<br/><div id="type_allOf_i0_ex1" class="jumbotron examples"><div class="highlight"><pre><span></span><span class="s2">&quot;Person&quot;</span>
             ...
             id="tab-pane_digitally_available_via_items_type_allOf_i1" role="tabpanel">
            

    <h4>Specific</h4><span class="badge badge-dark value-type">Type: const</span><br/>
<span class="const-value" id="digitally_available_via_items_type_allOf_i1_const">Specific value: <code>"DigitalService"</code></span>
...
<div class="accordion" id="accordiondigitally_available_via_items__label">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via_items__label">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via_items__label"
                        aria-expanded="" aria-controls="digitally_available_via_items__label" onclick="setAnchor('#digitally_available_via_items__label')"><span class="property-name">_label</span></button>
            </h2>
        </div>

        <div id="digitally_available_via_items__label"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via_items__label"
             data-parent="#accordiondigitally_available_via_items__label">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_available_via_items_identified_by">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via_items_identified_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via_items_identified_by"
                        aria-expanded="" aria-controls="digitally_available_via_items_identified_by" onclick="setAnchor('#digitally_available_via_items_identified_by')"><span class="property-name">identified_by</span></button>
            </h2>
        </div>

        <div id="digitally_available_via_items_identified_by"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via_items_identified_by"
             data-parent="#accordiondigitally_available_via_items_identified_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_available_via_items_classified_as">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via_items_classified_as">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via_items_classified_as"
                        aria-expanded="" aria-controls="digitally_available_via_items_classified_as" onclick="setAnchor('#digitally_available_via_items_classified_as')"><span class="property-name">classified_as</span></button>
            </h2>
        </div>

        <div id="digitally_available_via_items_classified_as"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via_items_classified_as"
             data-parent="#accordiondigitally_available_via_items_classified_as">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_available_via_items_referred_to_by">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via_items_referred_to_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via_items_referred_to_by"
                        aria-expanded="" aria-controls="digitally_available_via_items_referred_to_by" onclick="setAnchor('#digitally_available_via_items_referred_to_by')"><span class="property-name">referred_to_by</span></button>
            </h2>
        </div>

        <div id="digitally_available_via_items_referred_to_by"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via_items_referred_to_by"
             data-parent="#accordiondigitally_available_via_items_referred_to_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_available_via_items_access_point">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via_items_access_point">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via_items_access_point"
                        aria-expanded="" aria-controls="digitally_available_via_items_access_point" onclick="setAnchor('#digitally_available_via_items_access_point')"><span class="property-name">access_point</span></button>
            </h2>
        </div>

        <div id="digitally_available_via_items_access_point"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via_items_access_point"
             data-parent="#accordiondigitally_available_via_items_access_point">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_available_via_items_conforms_to">
    <div class="card">
        <div class="card-header" id="headingdigitally_available_via_items_conforms_to">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_available_via_items_conforms_to"
                        aria-expanded="" aria-controls="digitally_available_via_items_conforms_to" onclick="setAnchor('#digitally_available_via_items_conforms_to')"><span class="property-name">conforms_to</span></button>
            </h2>
        </div>

        <div id="digitally_available_via_items_conforms_to"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_available_via_items_conforms_to"
             data-parent="#accordiondigitally_available_via_items_conforms_to">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_carries">
    <div class="card">
        <div class="card-header" id="headingdigitally_carries">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_carries"
                        aria-expanded="" aria-controls="digitally_carries" onclick="setAnchor('#digitally_carries')"><span class="property-name">digitally_carries</span></button>
            </h2>
        </div>

        <div id="digitally_carries"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_carries"
             data-parent="#accordiondigitally_carries">
            <div class="card-body pl-5">

    <h4>la:digitally_carries</h4><span class="badge badge-dark value-type">Type: array</span><br/>
         ...
         <span class="badge badge-info no-additional">No Additional Items</span><h4>Each item of this array must be:</h4>
    <div class="card">
        <div class="card-body items-definition" id="digitally_carries_items">
...
<div class="accordion" id="accordiondigitally_carries_items_id">
    <div class="card">
        <div class="card-header" id="headingdigitally_carries_items_id">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_carries_items_id"
                        aria-expanded="" aria-controls="digitally_carries_items_id" onclick="setAnchor('#digitally_carries_items_id')"><span class="property-name">id</span> <span class="badge badge-warning required-property">Required</span></button>
            </h2>
        </div>

        <div id="digitally_carries_items_id"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_carries_items_id"
             data-parent="#accordiondigitally_carries_items_id">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_carries_items_type">
    <div class="card">
        <div class="card-header" id="headingdigitally_carries_items_type">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_carries_items_type"
                        aria-expanded="" aria-controls="digitally_carries_items_type" onclick="setAnchor('#digitally_carries_items_type')"><span class="property-name">type</span> <span class="badge badge-warning required-property">Required</span></button>
            </h2>
        </div>

        <div id="digitally_carries_items_type"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_carries_items_type"
             data-parent="#accordiondigitally_carries_items_type">
            <div class="card-body pl-5">

    <br/>
<div class="all-of-value" id="digitally_carries_items_type_allOf"><h2 class="handle">
  <label>All of</label>
</h2><ul class="nav nav-tabs" id="tabsdigitally_carries_items_type_allOf_allOf" role="tablist"><li class="nav-item">
            <a class="nav-link active allOf-option"
               id="digitally_carries_items_type_allOf_i0" data-toggle="tab" href="#tab-pane_digitally_carries_items_type_allOf_i0" role="tab"
               onclick="setAnchor('#digitally_carries_items_type_allOf_i0')"
            >General</a>
        </li><li class="nav-item">
            <a class="nav-link allOf-option"
               id="digitally_carries_items_type_allOf_i1" data-toggle="tab" href="#tab-pane_digitally_carries_items_type_allOf_i1" role="tab"
               onclick="setAnchor('#digitally_carries_items_type_allOf_i1')"
            >Requirement 2</a>
        </li></ul>
<div class="tab-content card"><div class="tab-pane fade card-body active show"
             id="tab-pane_digitally_carries_items_type_allOf_i0" role="tabpanel">
...
<br/><div id="type_allOf_i0_ex1" class="jumbotron examples"><div class="highlight"><pre><span></span><span class="s2">&quot;Person&quot;</span>
             ...
             id="tab-pane_digitally_carries_items_type_allOf_i1" role="tabpanel">
            

    <span class="badge badge-dark value-type">Type: const</span><br/>
<span class="const-value" id="digitally_carries_items_type_allOf_i1_const">Specific value: <code>"LinguisticObject"</code></span>
...
<div class="accordion" id="accordiondigitally_carries_items__label">
    <div class="card">
        <div class="card-header" id="headingdigitally_carries_items__label">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_carries_items__label"
                        aria-expanded="" aria-controls="digitally_carries_items__label" onclick="setAnchor('#digitally_carries_items__label')"><span class="property-name">_label</span></button>
            </h2>
        </div>

        <div id="digitally_carries_items__label"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_carries_items__label"
             data-parent="#accordiondigitally_carries_items__label">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_carries_items_equivalent">
    <div class="card">
        <div class="card-header" id="headingdigitally_carries_items_equivalent">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_carries_items_equivalent"
                        aria-expanded="" aria-controls="digitally_carries_items_equivalent" onclick="setAnchor('#digitally_carries_items_equivalent')"><span class="property-name">equivalent</span></button>
            </h2>
        </div>

        <div id="digitally_carries_items_equivalent"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_carries_items_equivalent"
             data-parent="#accordiondigitally_carries_items_equivalent">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_shows">
    <div class="card">
        <div class="card-header" id="headingdigitally_shows">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_shows"
                        aria-expanded="" aria-controls="digitally_shows" onclick="setAnchor('#digitally_shows')"><span class="property-name">digitally_shows</span></button>
            </h2>
        </div>

        <div id="digitally_shows"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_shows"
             data-parent="#accordiondigitally_shows">
            <div class="card-body pl-5">

    <h4>la:digitally_shows</h4><span class="badge badge-dark value-type">Type: array</span><br/>
         ...
         <span class="badge badge-info no-additional">No Additional Items</span><h4>Each item of this array must be:</h4>
    <div class="card">
        <div class="card-body items-definition" id="digitally_shows_items">
...
<div class="accordion" id="accordiondigitally_shows_items_id">
    <div class="card">
        <div class="card-header" id="headingdigitally_shows_items_id">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_shows_items_id"
                        aria-expanded="" aria-controls="digitally_shows_items_id" onclick="setAnchor('#digitally_shows_items_id')"><span class="property-name">id</span> <span class="badge badge-warning required-property">Required</span></button>
            </h2>
        </div>

        <div id="digitally_shows_items_id"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_shows_items_id"
             data-parent="#accordiondigitally_shows_items_id">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_shows_items_type">
    <div class="card">
        <div class="card-header" id="headingdigitally_shows_items_type">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_shows_items_type"
                        aria-expanded="" aria-controls="digitally_shows_items_type" onclick="setAnchor('#digitally_shows_items_type')"><span class="property-name">type</span> <span class="badge badge-warning required-property">Required</span></button>
            </h2>
        </div>

        <div id="digitally_shows_items_type"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_shows_items_type"
             data-parent="#accordiondigitally_shows_items_type">
            <div class="card-body pl-5">

    <br/>
<div class="all-of-value" id="digitally_shows_items_type_allOf"><h2 class="handle">
  <label>All of</label>
</h2><ul class="nav nav-tabs" id="tabsdigitally_shows_items_type_allOf_allOf" role="tablist"><li class="nav-item">
            <a class="nav-link active allOf-option"
               id="digitally_shows_items_type_allOf_i0" data-toggle="tab" href="#tab-pane_digitally_shows_items_type_allOf_i0" role="tab"
               onclick="setAnchor('#digitally_shows_items_type_allOf_i0')"
            >General</a>
        </li><li class="nav-item">
            <a class="nav-link allOf-option"
               id="digitally_shows_items_type_allOf_i1" data-toggle="tab" href="#tab-pane_digitally_shows_items_type_allOf_i1" role="tab"
               onclick="setAnchor('#digitally_shows_items_type_allOf_i1')"
            >Requirement 2</a>
        </li></ul>
<div class="tab-content card"><div class="tab-pane fade card-body active show"
             id="tab-pane_digitally_shows_items_type_allOf_i0" role="tabpanel">
...
<br/><div id="type_allOf_i0_ex1" class="jumbotron examples"><div class="highlight"><pre><span></span><span class="s2">&quot;Person&quot;</span>
             ...
             id="tab-pane_digitally_shows_items_type_allOf_i1" role="tabpanel">
            

    <span class="badge badge-dark value-type">Type: const</span><br/>
<span class="const-value" id="digitally_shows_items_type_allOf_i1_const">Specific value: <code>"VisualItem"</code></span>
...
<div class="accordion" id="accordiondigitally_shows_items__label">
    <div class="card">
        <div class="card-header" id="headingdigitally_shows_items__label">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_shows_items__label"
                        aria-expanded="" aria-controls="digitally_shows_items__label" onclick="setAnchor('#digitally_shows_items__label')"><span class="property-name">_label</span></button>
            </h2>
        </div>

        <div id="digitally_shows_items__label"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_shows_items__label"
             data-parent="#accordiondigitally_shows_items__label">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondigitally_shows_items_equivalent">
    <div class="card">
        <div class="card-header" id="headingdigitally_shows_items_equivalent">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#digitally_shows_items_equivalent"
                        aria-expanded="" aria-controls="digitally_shows_items_equivalent" onclick="setAnchor('#digitally_shows_items_equivalent')"><span class="property-name">equivalent</span></button>
            </h2>
        </div>

        <div id="digitally_shows_items_equivalent"
             class="collapse property-definition-div" aria-labelledby="headingdigitally_shows_items_equivalent"
             data-parent="#accordiondigitally_shows_items_equivalent">
            <div class="card-body pl-5">
