...
<script src="/api/1.0/schema_docs/schema_doc.min.js"></script><div onload="anchorOnLoad();" id="root">
     ...
     <h1>Group Schema</h1><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p><em>crm:E74_Group</em><br />
A Group of People and/or other Groups.<br />
See: <a href="https://linked.art/api/1.0/endpoint/group/">API</a> | <a href="https://linked.art/model/actor/">Model</a></p>
...
<span class="const-value" id="type_allOf_i1_const">Specific value: <code>"Group"</code></span>
...
<span class="description"><p>List of <code>Group</code> entities</p>
</span>
...
<span class="description"><p>Reference to a <code>Group</code><br />
See: <a href="group.html">Schema</a></p>
</span><a href="#identified_by_items_anyOf_i1_assigned_by_items_carried_out_by_items_anyOf_i1" onclick="anchorLink('identified_by_items_anyOf_i1_assigned_by_items_carried_out_by_items_anyOf_i1')" class="ref-link">Same definition as crm:E74_Group</a>
        </div>
    </div>
        </div></div></div>
...
<span class="description"><p>A reference to one or more <code>Group</code> entities of which this entity is a member</p>
</span>
...
<span class="description"><p>One or more activities which this entity carried out or performed</p>
</span>
...
<span class="description"><p>One or more activities which this entity participated in, but did not carry out directly</p>
</span>
    ...
    <h4>crm:E7_Activity</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p>An activity carried out by some person or group</p>
</span><a href="#carried_out_items" onclick="anchorLink('carried_out_items')" class="ref-link">Same definition as crm:E7_Activity</a>
        </div>
    </div>
            </div>
        </div>
...
<span class="description"><p>An identifier which can be used as a contact point or address for the entity, such as an email address</p>
</span>
...
<span class="description"><p>A <code>Place</code> where this entity has resided or done business</p>
</span>
...
<span class="description"><p>Reference to a <code>Place</code> entity<br />
See: <a href="place.html">Schema</a></p>
</span><a href="#identified_by_items_anyOf_i1_assigned_by_items_took_place_at_items" onclick="anchorLink('identified_by_items_anyOf_i1_assigned_by_items_took_place_at_items')" class="ref-link">Same definition as crm:E53_Place</a>
        </div>
    </div>
            </div>
        </div>
...
<div class="accordion" id="accordionformed_by">
    <div class="card">
        <div class="card-header" id="headingformed_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by"
                        aria-expanded="" aria-controls="formed_by" onclick="setAnchor('#formed_by')"><span class="property-name">formed_by</span></button>
            </h2>
        </div>

        <div id="formed_by"
             class="collapse property-definition-div" aria-labelledby="headingformed_by"
             data-parent="#accordionformed_by">
            <div class="card-body pl-5">

    <h4>crm:P95i_was_formed_by</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p>The activity of forming or creating the Group</p>
</span>
...
<div class="accordion" id="accordionformed_by_type">
    <div class="card">
        <div class="card-header" id="headingformed_by_type">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_type"
                        aria-expanded="" aria-controls="formed_by_type" onclick="setAnchor('#formed_by_type')"><span class="property-name">type</span></button>
            </h2>
        </div>

        <div id="formed_by_type"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_type"
             data-parent="#accordionformed_by_type">
            <div class="card-body pl-5">

    <br/>
<div class="all-of-value" id="formed_by_type_allOf"><h2 class="handle">
  <label>All of</label>
</h2><ul class="nav nav-tabs" id="tabsformed_by_type_allOf_allOf" role="tablist"><li class="nav-item">
            <a class="nav-link active allOf-option"
               id="formed_by_type_allOf_i0" data-toggle="tab" href="#tab-pane_formed_by_type_allOf_i0" role="tab"
               onclick="setAnchor('#formed_by_type_allOf_i0')"
            >General</a>
        </li><li class="nav-item">
            <a class="nav-link allOf-option"
               id="formed_by_type_allOf_i1" data-toggle="tab" href="#tab-pane_formed_by_type_allOf_i1" role="tab"
               onclick="setAnchor('#formed_by_type_allOf_i1')"
            >Specific</a>
        </li></ul>
<div class="tab-content card"><div class="tab-pane fade card-body active show"
             id="tab-pane_formed_by_type_allOf_i0" role="tabpanel">
...
<br/><div id="type_allOf_i0_ex1" class="jumbotron examples"><div class="highlight"><pre><span></span><span class="s2">&quot;Person&quot;</span>
             ...
             id="tab-pane_formed_by_type_allOf_i1" role="tabpanel">
            

    <h4>Specific</h4><span class="badge badge-dark value-type">Type: const</span><br/>
<span class="const-value" id="formed_by_type_allOf_i1_const">Specific value: <code>"Formation"</code></span>
...
<div class="accordion" id="accordionformed_by__label">
    <div class="card">
        <div class="card-header" id="headingformed_by__label">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by__label"
                        aria-expanded="" aria-controls="formed_by__label" onclick="setAnchor('#formed_by__label')"><span class="property-name">_label</span></button>
            </h2>
        </div>

        <div id="formed_by__label"
             class="collapse property-definition-div" aria-labelledby="headingformed_by__label"
             data-parent="#accordionformed_by__label">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_identified_by">
    <div class="card">
        <div class="card-header" id="headingformed_by_identified_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_identified_by"
                        aria-expanded="" aria-controls="formed_by_identified_by" onclick="setAnchor('#formed_by_identified_by')"><span class="property-name">identified_by</span></button>
            </h2>
        </div>

        <div id="formed_by_identified_by"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_identified_by"
             data-parent="#accordionformed_by_identified_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_classified_as">
    <div class="card">
        <div class="card-header" id="headingformed_by_classified_as">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_classified_as"
                        aria-expanded="" aria-controls="formed_by_classified_as" onclick="setAnchor('#formed_by_classified_as')"><span class="property-name">classified_as</span></button>
            </h2>
        </div>

        <div id="formed_by_classified_as"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_classified_as"
             data-parent="#accordionformed_by_classified_as">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_referred_to_by">
    <div class="card">
        <div class="card-header" id="headingformed_by_referred_to_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_referred_to_by"
                        aria-expanded="" aria-controls="formed_by_referred_to_by" onclick="setAnchor('#formed_by_referred_to_by')"><span class="property-name">referred_to_by</span></button>
            </h2>
        </div>

        <div id="formed_by_referred_to_by"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_referred_to_by"
             data-parent="#accordionformed_by_referred_to_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_took_place_at">
    <div class="card">
        <div class="card-header" id="headingformed_by_took_place_at">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_took_place_at"
                        aria-expanded="" aria-controls="formed_by_took_place_at" onclick="setAnchor('#formed_by_took_place_at')"><span class="property-name">took_place_at</span></button>
            </h2>
        </div>

        <div id="formed_by_took_place_at"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_took_place_at"
             data-parent="#accordionformed_by_took_place_at">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_timespan">
    <div class="card">
        <div class="card-header" id="headingformed_by_timespan">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_timespan"
                        aria-expanded="" aria-controls="formed_by_timespan" onclick="setAnchor('#formed_by_timespan')"><span class="property-name">timespan</span></button>
            </h2>
        </div>

        <div id="formed_by_timespan"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_timespan"
             data-parent="#accordionformed_by_timespan">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_caused_by">
    <div class="card">
        <div class="card-header" id="headingformed_by_caused_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_caused_by"
                        aria-expanded="" aria-controls="formed_by_caused_by" onclick="setAnchor('#formed_by_caused_by')"><span class="property-name">caused_by</span></button>
            </h2>
        </div>

        <div id="formed_by_caused_by"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_caused_by"
             data-parent="#accordionformed_by_caused_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_carried_out_by">
    <div class="card">
        <div class="card-header" id="headingformed_by_carried_out_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_carried_out_by"
                        aria-expanded="" aria-controls="formed_by_carried_out_by" onclick="setAnchor('#formed_by_carried_out_by')"><span class="property-name">carried_out_by</span></button>
            </h2>
        </div>

        <div id="formed_by_carried_out_by"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_carried_out_by"
             data-parent="#accordionformed_by_carried_out_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_used_specific_object">
    <div class="card">
        <div class="card-header" id="headingformed_by_used_specific_object">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_used_specific_object"
                        aria-expanded="" aria-controls="formed_by_used_specific_object" onclick="setAnchor('#formed_by_used_specific_object')"><span class="property-name">used_specific_object</span></button>
            </h2>
        </div>

        <div id="formed_by_used_specific_object"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_used_specific_object"
             data-parent="#accordionformed_by_used_specific_object">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_influenced_by">
    <div class="card">
        <div class="card-header" id="headingformed_by_influenced_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_influenced_by"
                        aria-expanded="" aria-controls="formed_by_influenced_by" onclick="setAnchor('#formed_by_influenced_by')"><span class="property-name">influenced_by</span></button>
            </h2>
        </div>

        <div id="formed_by_influenced_by"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_influenced_by"
             data-parent="#accordionformed_by_influenced_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_technique">
    <div class="card">
        <div class="card-header" id="headingformed_by_technique">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_technique"
                        aria-expanded="" aria-controls="formed_by_technique" onclick="setAnchor('#formed_by_technique')"><span class="property-name">technique</span></button>
            </h2>
        </div>

        <div id="formed_by_technique"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_technique"
             data-parent="#accordionformed_by_technique">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_during">
    <div class="card">
        <div class="card-header" id="headingformed_by_during">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_during"
                        aria-expanded="" aria-controls="formed_by_during" onclick="setAnchor('#formed_by_during')"><span class="property-name">during</span></button>
            </h2>
        </div>

        <div id="formed_by_during"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_during"
             data-parent="#accordionformed_by_during">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_after">
    <div class="card">
        <div class="card-header" id="headingformed_by_after">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_after"
                        aria-expanded="" aria-controls="formed_by_after" onclick="setAnchor('#formed_by_after')"><span class="property-name">after</span></button>
            </h2>
        </div>

        <div id="formed_by_after"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_after"
             data-parent="#accordionformed_by_after">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_before">
    <div class="card">
        <div class="card-header" id="headingformed_by_before">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_before"
                        aria-expanded="" aria-controls="formed_by_before" onclick="setAnchor('#formed_by_before')"><span class="property-name">before</span></button>
            </h2>
        </div>

        <div id="formed_by_before"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_before"
             data-parent="#accordionformed_by_before">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordionformed_by_part_of">
    <div class="card">
        <div class="card-header" id="headingformed_by_part_of">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#formed_by_part_of"
                        aria-expanded="" aria-controls="formed_by_part_of" onclick="setAnchor('#formed_by_part_of')"><span class="property-name">part_of</span></button>
            </h2>
        </div>

        <div id="formed_by_part_of"
             class="collapse property-definition-div" aria-labelledby="headingformed_by_part_of"
             data-parent="#accordionformed_by_part_of">
            <div class="card-body pl-5">

    <h4>crm:P9i_forms_part_of</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p>An identified event or activity which this formation is part of</p>
</span>
...
<div class="accordion" id="accordiondissolved_by">
    <div class="card">
        <div class="card-header" id="headingdissolved_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by"
                        aria-expanded="" aria-controls="dissolved_by" onclick="setAnchor('#dissolved_by')"><span class="property-name">dissolved_by</span></button>
            </h2>
        </div>

        <div id="dissolved_by"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by"
             data-parent="#accordiondissolved_by">
            <div class="card-body pl-5">

    <h4>crm:P99i_was_dissolved_by</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p>The activity of dissolving or ending the Group</p>
</span>
...
<div class="accordion" id="accordiondissolved_by_type">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_type">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_type"
                        aria-expanded="" aria-controls="dissolved_by_type" onclick="setAnchor('#dissolved_by_type')"><span class="property-name">type</span></button>
            </h2>
        </div>

        <div id="dissolved_by_type"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_type"
             data-parent="#accordiondissolved_by_type">
            <div class="card-body pl-5">

    <br/>
<div class="all-of-value" id="dissolved_by_type_allOf"><h2 class="handle">
  <label>All of</label>
</h2><ul class="nav nav-tabs" id="tabsdissolved_by_type_allOf_allOf" role="tablist"><li class="nav-item">
            <a class="nav-link active allOf-option"
               id="dissolved_by_type_allOf_i0" data-toggle="tab" href="#tab-pane_dissolved_by_type_allOf_i0" role="tab"
               onclick="setAnchor('#dissolved_by_type_allOf_i0')"
            >General</a>
        </li><li class="nav-item">
            <a class="nav-link allOf-option"
               id="dissolved_by_type_allOf_i1" data-toggle="tab" href="#tab-pane_dissolved_by_type_allOf_i1" role="tab"
               onclick="setAnchor('#dissolved_by_type_allOf_i1')"
            >Specific</a>
        </li></ul>
<div class="tab-content card"><div class="tab-pane fade card-body active show"
             id="tab-pane_dissolved_by_type_allOf_i0" role="tabpanel">
...
<br/><div id="type_allOf_i0_ex1" class="jumbotron examples"><div class="highlight"><pre><span></span><span class="s2">&quot;Person&quot;</span>
             ...
             id="tab-pane_dissolved_by_type_allOf_i1" role="tabpanel">
            

    <h4>Specific</h4><span class="badge badge-dark value-type">Type: const</span><br/>
<span class="const-value" id="dissolved_by_type_allOf_i1_const">Specific value: <code>"Dissolution"</code></span>
...
<div class="accordion" id="accordiondissolved_by__label">
    <div class="card">
        <div class="card-header" id="headingdissolved_by__label">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by__label"
                        aria-expanded="" aria-controls="dissolved_by__label" onclick="setAnchor('#dissolved_by__label')"><span class="property-name">_label</span></button>
            </h2>
        </div>

        <div id="dissolved_by__label"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by__label"
             data-parent="#accordiondissolved_by__label">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_identified_by">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_identified_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_identified_by"
                        aria-expanded="" aria-controls="dissolved_by_identified_by" onclick="setAnchor('#dissolved_by_identified_by')"><span class="property-name">identified_by</span></button>
            </h2>
        </div>

        <div id="dissolved_by_identified_by"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_identified_by"
             data-parent="#accordiondissolved_by_identified_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_classified_as">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_classified_as">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_classified_as"
                        aria-expanded="" aria-controls="dissolved_by_classified_as" onclick="setAnchor('#dissolved_by_classified_as')"><span class="property-name">classified_as</span></button>
            </h2>
        </div>

        <div id="dissolved_by_classified_as"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_classified_as"
             data-parent="#accordiondissolved_by_classified_as">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_referred_to_by">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_referred_to_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_referred_to_by"
                        aria-expanded="" aria-controls="dissolved_by_referred_to_by" onclick="setAnchor('#dissolved_by_referred_to_by')"><span class="property-name">referred_to_by</span></button>
            </h2>
        </div>

        <div id="dissolved_by_referred_to_by"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_referred_to_by"
             data-parent="#accordiondissolved_by_referred_to_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_took_place_at">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_took_place_at">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_took_place_at"
                        aria-expanded="" aria-controls="dissolved_by_took_place_at" onclick="setAnchor('#dissolved_by_took_place_at')"><span class="property-name">took_place_at</span></button>
            </h2>
        </div>

        <div id="dissolved_by_took_place_at"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_took_place_at"
             data-parent="#accordiondissolved_by_took_place_at">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_timespan">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_timespan">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_timespan"
                        aria-expanded="" aria-controls="dissolved_by_timespan" onclick="setAnchor('#dissolved_by_timespan')"><span class="property-name">timespan</span></button>
            </h2>
        </div>

        <div id="dissolved_by_timespan"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_timespan"
             data-parent="#accordiondissolved_by_timespan">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_caused_by">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_caused_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_caused_by"
                        aria-expanded="" aria-controls="dissolved_by_caused_by" onclick="setAnchor('#dissolved_by_caused_by')"><span class="property-name">caused_by</span></button>
            </h2>
        </div>

        <div id="dissolved_by_caused_by"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_caused_by"
             data-parent="#accordiondissolved_by_caused_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_influenced_by">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_influenced_by">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_influenced_by"
                        aria-expanded="" aria-controls="dissolved_by_influenced_by" onclick="setAnchor('#dissolved_by_influenced_by')"><span class="property-name">influenced_by</span></button>
            </h2>
        </div>

        <div id="dissolved_by_influenced_by"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_influenced_by"
             data-parent="#accordiondissolved_by_influenced_by">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_during">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_during">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_during"
                        aria-expanded="" aria-controls="dissolved_by_during" onclick="setAnchor('#dissolved_by_during')"><span class="property-name">during</span></button>
            </h2>
        </div>

        <div id="dissolved_by_during"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_during"
             data-parent="#accordiondissolved_by_during">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_after">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_after">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_after"
                        aria-expanded="" aria-controls="dissolved_by_after" onclick="setAnchor('#dissolved_by_after')"><span class="property-name">after</span></button>
            </h2>
        </div>

        <div id="dissolved_by_after"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_after"
             data-parent="#accordiondissolved_by_after">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_before">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_before">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_before"
                        aria-expanded="" aria-controls="dissolved_by_before" onclick="setAnchor('#dissolved_by_before')"><span class="property-name">before</span></button>
            </h2>
        </div>

        <div id="dissolved_by_before"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_before"
             data-parent="#accordiondissolved_by_before">
            <div class="card-body pl-5">
...
<div class="accordion" id="accordiondissolved_by_part_of">
    <div class="card">
        <div class="card-header" id="headingdissolved_by_part_of">
            <h2 class="mb-0">
                <button class="btn btn-link property-name-button" type="button" data-toggle="collapse" data-target="#dissolved_by_part_of"
                        aria-expanded="" aria-controls="dissolved_by_part_of" onclick="setAnchor('#dissolved_by_part_of')"><span class="property-name">part_of</span></button>
            </h2>
        </div>

        <div id="dissolved_by_part_of"
             class="collapse property-definition-div" aria-labelledby="headingdissolved_by_part_of"
             data-parent="#accordiondissolved_by_part_of">
            <div class="card-body pl-5">

    <h4>crm:P9i_forms_part_of</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p>An identified event or activity which this dissolution is part of</p>
</span>
