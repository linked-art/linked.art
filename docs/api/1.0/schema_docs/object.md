...
<span class="description"><p><em>crm:E22_Human-Made_Object</em><br />
A human-made object, part thereof, or a natural object with value imbued through interaction with human culture.<br />
See: <a href="https://linked.art/api/1.0/endpoint/object/">API</a> | <a href="https://linked.art/model/object/">Model</a></p>
...
<span class="description"><p>List of <code>HumanMadeObject</code> entities</p>
</span>
...
<span class="description"><p>One or more <code>Material</code> types of which this object is made</p>
</span>
...
<span class="description"><p>Reference to a <code>Material</code></p>
</span>
...
<span class="description"><p>Another Human-Made Object of which this Object is part</p>
</span>
...
<span class="description"><p>The current owner (a <code>Person</code> or <code>Group</code>) of this object</p>
</span>
...
<span class="description"><p>The current custodian (a <code>Person</code> or <code>Group</code>) of this object, if different from its owner</p>
</span>
...
<span class="description"><p>The current normal custodian (a <code>Person</code> or <code>Group</code>) if different from the current custodian, for example an object that is owned by an individual, currently in an exhibition, and normally under the custody of an organization</p>
</span>
...
<span class="description"><p>The current location (a <code>Place</code>) of this object</p>
</span>
...
<div class="accordion" id="accordioncurrent_permanent_location">
    ...
    <h4>crm:P55_has_current_location</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p>The current location (a <code>Place</code>) of this object</p>
</span><a href="#current_location" onclick="anchorLink('current_location')" class="ref-link">Same definition as current_location</a>
            </div>
        </div>
    </div>
</div>
...
<span class="description"><p>The physical object which holds/contains or supports this object</p>
</span>
...
<span class="description"><p>One or more other activities without their own identities in which this object was used</p>
</span>
...
<span class="description"><p>A reference to a <code>VisualItem</code> that this object shows the image content of</p>
</span>
...
<span class="description"><p>A reference to a <code>LinguisticObject</code> that this object carries the textual content of</p>
</span>
...
<span class="description"><p>The <code>Production</code> activity which created this object</p>
</span>
...
<span class="description"><p>The production/creation of the object</p>
</span><a href="#produced_by" onclick="anchorLink('produced_by')" class="ref-link">Same definition as produced_by</a>
        </div>
    </div>
            </div>
        </div>
...
<span class="description"><p>The <code>Destruction</code> event in which this object was destroyed</p>
</span>
...
<div class="accordion" id="accordiondestroyed_by_part_of">
    ...
    <h4>crm:P9i_forms_part_of</h4><span class="badge badge-dark value-type">Type: object</span><br/>
<span class="description"><p>An identified event or activity which this event is part of</p>
</span>
...
<span class="description"><p>One or more <code>PartRemoval</code> activities in which this object was removed from another object</p>
</span>
...
<span class="description"><p>The activity of removing this object from some other object.</p>
</span>
...
<span class="description"><p>A reference to the object which the object was removed from</p>
</span>
...
<span class="description"><p>One or more Encounter activities in which this object was encountered</p>
</span>
...
<span class="description"><p>The activity during which this object was encountered, found or discovered.</p>
</span>
...
<span class="description"><p>One or more Modification activities in which this object was modified</p>
</span>
...
<span class="description"><p>A modification of the object</p>
</span>
...
<span class="description"><p>One or more Acquisition activities in which the object changed ownership</p>
</span>
...
<span class="description"><p>An acquisition of the object</p>
</span>
