...
And if you would like to suggest additions that you think would be interesting, for example, new terms that mitigate a bias resulting from the somewhat adhoc process of gathering the lists here, please [reach out](https://linked.art/community/)!
