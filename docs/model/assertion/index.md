...
stmt = vocab.Description(content="Rembrandt's "The Night Watch" is a dynamic 17th-century group portrait of an Amsterdam militia company, renowned for its dramatic use of light and shadow and its departure from traditional static compositions.")
cre = model.Creation()
ts = model.TimeSpan()
