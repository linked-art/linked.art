...
```crom
top = vocab.MultiExhibition(ident="auto int-per-segment")
...
toc = model.TransferOfCustody()
toc._label = "Custody Transfer of Painting for Exhibition"
exh = vocab.Exhibition()
...
owner = vocab.MuseumOrg()
owner._label = "Owning Museum"
toc.transferred_custody_of = obj
toc.transferred_custody_to = mus
toc.transferred_custody_from = owner
toc.specific_purpose = exh
agg = model.Set()
agg.member = obj
...
top = vocab.ProvenanceEntry(ident="auto int-per-segment")
mv = model.Move()
mv._label = "Move of object for exhibition"
exh = vocab.Exhibition()
exh._label = "Example Exhibition"
obj = vocab.Painting(art=1)
...
mv.moved = obj
mv.specific_purpose = exh
obj.current_owner = mus
agg.member = obj
exh.used_specific_object = agg
exh.carried_out_by = mus
mv.carried_out_by = mus
top.part = mv
```
